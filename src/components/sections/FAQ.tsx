...
const faqs = [
  {
    ...
    answer: [
      "運用資金は最低50万円程度から開始可能です。",
      "資金量に応じた運用プランをご提案いたしますので、",
  ...
  },
  {
    ...
    answer: [
      ...
      "ヤフショの規約変更等により、",
      "利益が変動する可能性があります。",
      "リスクを最小化するための運用設計を行っていますが、",
      "投資である以上、",
      "損失の可能性がゼロではないことをご理解ください。",
    ],
  },
  {
    question: "契約期間はありますか？",
  ...
  },
  {
    ...
    answer: [
      "毎月、",
      "利益計算と運用状況をまとめたレポートをお送りします。",
      "収支の詳細、",
      "運用した商品、",
      "今後の改善提案などを含む詳細な報告書です。",
    ],
  },
  {
    question: "アカウント停止などのリスクはありますか？",
    answer: [
      "ヤフショの規約に準拠した運用を行っていますが、",
      "規約変更等によりリスクが発生する可能性はあります。",
      "リスク管理についても運用設計に含めて対応しています。",
    ],
  },
  {
    ...
    answer: [
      "外注さんの採用や教育については、",
      "初期構築の段階でフローとルールをお伝えします。",
      "購入指示は当方から外注さんへ直接行いますので、",
      "オーナー様の作業は不要です。",
    ],
  },
];
